...
//Importing Modules for user input from console
...
const keyDirectoryPath = envOrDefault('KEY_DIRECTORY_PATH', path.resolve(__dirname, '..', '..' , 'Clients' , 'User1-Identities' , 'Private-Key'));

// Path to user certificate.
const certPath = envOrDefault('CERT_PATH', path.resolve(__dirname, '..', '..' , 'Clients' , 'User1-Identities' , 'certificate.pem'));

// Path to peer tls certificate.
const tlsCertPath = envOrDefault('TLS_CERT_PATH', path.resolve(cryptoPath, 'peers', 'peer1.org0.example.com', 'tls', 'ca.crt'));
...
var SerializedTFile: string;
var StudentID : string;
var StudentName: string;
var RequestingSchool: string;
...
async function main(): Promise<void> {
    ...
    try {
        ...
        SerializedTFile = prompt(`Enter Anything`);
        ApprovedBy = prompt(`Who approved the transcript`);
        //-------------------------------
